# -*- coding: utf-8 -*-
"""jomato_zomato_brianic.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1e4XdQUjvxJedSIKJiMm7xBBCt5H5EkMb
"""

import requests

key = "0aa5d9130201117c126a4e43a03b0e01"
print("===== SELAMAT DATANG DI APLIKASI JOMATO =====", "SILAHKAN PILIH OPSI:",f"{' '*2} 1. Cari Restoran", f"{' '*2} 2. Menu Harian", sep = '\n')
...
if option == '1':
  ...
  while True:
    try:
      ...
      print("Maaf, nama kota tidak ada.")
      continue
    else:
      break
  ...
  for i in range(int(resto_show)):
    ...
    try:
      print(f"Daily Menu: {len(dmenu['daily_menus'])}")
      # print(dmenu)
    except KeyError:
      print("Maaf, tidak tersedia informasi Daily Menu pada restoran ini.")
    print('\n')
...
if option == '2':
  ...
  while True:
    try:
      ...
      print(f"Jumlah menu di {restaurant_name.upper()} {city_name.capitalize()} adalah 0 menu.")
      break
    else:
      break